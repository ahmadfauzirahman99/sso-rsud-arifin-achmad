...
<div class="tb-pegawai-search">
    ...
    <?php // echo $form->field($model, 'pendidikan_terakhir_id') ?>
    ...
    <?php // echo $form->field($model, 'pangkat_terakhir_id') ?>
    ...
    <?php // echo $form->field($model, 'jenis_jabatan') ?>

    <?php // echo $form->field($model, 'kode_jabatan') ?>

    <?php // echo $form->field($model, 'kode_bagian') ?>

    <?php // echo $form->field($model, 'fungsional_struktural') ?>
