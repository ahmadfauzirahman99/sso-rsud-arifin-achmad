...
<style>
    ...
    .form-content {
        ...
        background-image: url("<?= Yii::$app->request->baseUrl ?>/img/GEDUNG-RSUD3.jpg") !important;
        ...
        <div class="form-holder">
            <div class="form-content">
                <div class="form-items">
                    ...
                    <hr>
                    <h3>Sistem Informasi <span style="color: white!important;">Manajemen</span> Rumah Sakit</h3>
                    ...
                    <form method="post" action="#">
                        ...
                        <div class="form-button">
                            ...
                            <button id="submit" type="submit" class="btn btn-success btn-lg btn-block">Login</button>
                        </div>
                    </form>
                </div>
            </div>
