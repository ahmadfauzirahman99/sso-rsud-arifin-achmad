...
<body class="page-profile">
    ...
    <aside class="aside aside-fixed">
        <div class="aside-header">
            <a href="<?= Yii::$app->urlManager->createUrl('site/index') ?>" class="aside-logo"><b><strong>Point
                        <span>Of Services</span></strong></b></a>
            ...
            <div class="aside-loggedin">
                ...
                <div class="collapse" id="loggedinMenu">
                    <ul class="nav nav-aside mg-b-0">
                        ...
                        <li class="nav-item"><a href="#global-logout-modal" data-toggle="modal" class="nav-link"><i data-feather="log-out"></i>
    ...
    <!--modal logout-->
    <div class="modal fade" id="global-logout-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel2" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content tx-14">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary tx-13" data-dismiss="modal">Nggak</button>
