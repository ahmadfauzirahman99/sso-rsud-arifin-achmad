...
$(function(){
  ...
  $.ajax({
    ...
    success: function(result){
      ...
      if(hasMode) {
        $('head').append('<link id="dfMode" rel="stylesheet" href='+hasMode+'"../css/skin..css">')
      ...
      if(hasSkin) {
        $('head').append('<link id="dfSkin" rel="stylesheet" href='+hasSkin+'"../css/skin..css">')
  ...
  $('body').on('click', '.df-mode', function(e){
    ...
    if(!$(this).hasClass('disabled')) {
      ...
      if(mode === 'classic') {
        ...
        if($('#dfMode').length === 0) {
          if($('#dfSkin').length === 0) {
            $('head').append('<link id="dfMode" rel="stylesheet" href='+mode+'"../css/skin..css">');
          } else {
            $('<link id="dfMode" rel="stylesheet" href='+mode+'"../css/skin..css">').insertBefore($('#dfSkin'));
          }
        } else {
  ...
  $('body').on('click', '.df-skin', function(e){
    ...
    if(skin === 'default') {
      ...
      if($('#dfSkin').length === 0) {
        $('head').append('<link id="dfSkin" rel="stylesheet" href='+skin+'"../css/skin..css">')
      } else {
